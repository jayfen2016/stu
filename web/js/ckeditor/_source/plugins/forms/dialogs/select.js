...
For licensing, see LICENSE.html or http://ckeditor.com/license
 ...
 4.data-xtype  控件类型  默认mychosen
 5.data-dtype 是数据库的类型 默认都是 int
 6 size  高度
 7 class 类样式
 8 style 行内样式
 9 multiple ="true" 允许多选
*/
CKEDITOR.dialog.add( 'select', function( editor )
{
	...
	return {
		...
		minHeight : CKEDITOR.env.ie ? 360 : 340,
		onShow : function()
		{
						...
						children: [
							...
							},
							{
								...
								setup:  function( name, element )
								{
									if ( name == 'clear' )
										this.setValue( '' );
									else if ( name == 'select' && element.getAttribute( 'style' ) )
